...
import "./style.css";
const blogheader = "./img/blogheader2.png";
...
const img1 = "./img/headerpost/img1.png";
const img2 = "./img/headerpost/img2.png";
...
const blogs = [
  {
    ...
    href: "#",
    time: "08.08.2021",
    imageSrc: "./img/headerpost/blog1.png",
  ...
  },
  {
    ...
    href: "#",
    time: "08.08.2021",
    imageSrc: "./img/headerpost/blog2.png",
    header: "Richird Norton photorealistic rendering as real photos",
    title:
      "Progressively incentivize cooperative systems through technically sound functionalities. Credibly productivate seamless data with flexible schemas.",
  },
    ...
    <div>
      ...
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl ">
        <div className="grid grid-cols-6 gap-5">
          ...
          <div className="col-start-2 col-end-7">
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-1 lg:grid-cols-2 xl:gap-x-5 py-8">
              <img
                src={img1}
                alt="post"
            ...
            <p className="text-base font-normal leading-6 text-justify text-gray-500">
              Authoritatively supply market-driven mindshare and
      ...
      <div className="bg-neutral-100">
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 ">
          <h2 className="text-2xl font-extrabold tracking-tight text-gray-500">
            Related Posts
          </h2>
          <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-5">
            {blogs.map((blog) => (
              <div key={blog.id} className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    <p className="mt-1 text-xs text-gray-500">{blog.time}</p>
                    ...
                    <p className="mt-1 text-xs text-gray-500 text-justify">
                      {blog.title}
                    </p>
                  </div>
                </div>
